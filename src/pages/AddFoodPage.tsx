...
export function AddFoodPage() {
  ...
  return (
    <div className="w-full max-w-3xl space-y-8">
      ...
      <form onSubmit={(event) => { event.preventDefault(); setSaved(true) }} className="space-y-6 rounded-[2rem] border border-[#e5e1d5] bg-white p-5 shadow-[0_8px_24px_rgba(70,67,52,0.05)] sm:p-8">
        ...
        {saved && <p role="status" className="rounded-xl bg-[#dce9de] px-4 py-3 text-sm font-bold text-[#426a5a]">Food preview ready. It will use your storage and opened state to estimate freshness.</p>}
      </form>
